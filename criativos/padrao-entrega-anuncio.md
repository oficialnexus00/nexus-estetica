# Padrão de entrega — copy de anúncio a partir de uma arte

> **Regra permanente do Kaian:** toda vez que uma arte for jogada aqui pedindo copy,
> é **pra anúncio**. Entregar sempre o pacote completo abaixo, em **2 variações**,
> sem precisar perguntar.

## O que sai, sempre

Para **cada uma das 2 variações**:
...
Agressivo é **confronto com a situação**, não com o corpo da pessoa.

| Pode | Não pode |
|---|---|
| Atacar o gasto recorrente, a rotina, o tempo perdido | Atacar aparência ou gerar vergonha corporal |
| Escassez real (vagas, prazo, lote) | Escassez inventada que não se cumpre |
| Número concreto e verificável | "Resultado garantido", "definitivo", "100%" |
| Comparação de custo com a alternativa | Comparação depreciativa com o concorrente |

> Peça em saúde/estética que apela pra insegurança corporal **reprova no Meta** e
> queima a marca. Ver [`checklist-de-aprovacao.md`](./checklist-de-aprovacao.md).
