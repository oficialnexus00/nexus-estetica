...
1. **"Hoje o disparo traz gente pra sua porta — e quem atende?"**
   O disparo sozinho gera demanda que morre sem resposta. A IA é o que fecha o loop.
   Ela está pagando 397 pra encher um funil que vaza.
2. **Âncora de recepcionista.** Uma menina de WhatsApp CLT custa ~R$ 2.400/mês
   carregada, atende 8h e sai de férias. O pacote inteiro custa metade e não dorme.
3. **Um agendamento paga.** Com ticket de depilação a laser, um pacote fechado a
   mais no mês já cobre a diferença de R$ 900.
4. **Ativação assistida** — ela não vai ficar sozinha com a ferramenta. É isso que a
   NEXUS vende, não licença de software.
...
*(Se ela pedir desconto: "o valor é esse, mas se fechar essa semana eu embuto a
ativação de R$ 997". Nunca mexer no mensal.)*

---

## Regras que este caso aplica
